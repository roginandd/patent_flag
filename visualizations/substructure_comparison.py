"""
Substructure Search Results Visualization
Analyzes patent flag results from substructure searches
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Visualize substructure search results from patent flagging',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python substructure_comparison.py
  python substructure_comparison.py --substructure substructure --output results.png
  python substructure_comparison.py -s ./substructure -o output/comparison.png
        """
    )
    ...
    parser.add_argument(
        ...
        help='Path to substructure results directory (default: substructure)'
    )
    parser.add_argument(
        '-o', '--output',
        type=str,
        default='visualizations/substructure_comparison.png',
        help='Output path for visualization (default: visualizations/substructure_comparison.png)'
    )
    
    args = parser.parse_args()
    
    substructure_dir = Path(args.substructure)
    ...
    files_info = {
        'generated_set': [
            ...
            ('top_10_molecules', 'top_10_molecules'),
        ],
        'training_dataset': [
    ...
    for category, file_pairs in files_info.items():
        ...
        for data_name, scaffold_name in file_pairs:
            full_file = substructure_dir / category / f"{data_name}_exact_flag.csv"
            scaffold_file = substructure_dir / category / f"{scaffold_name}_scaffold_flag.csv"
    ...
    fig.suptitle('Substructure Checking', fontsize=14, fontweight='bold', y=0.98)
